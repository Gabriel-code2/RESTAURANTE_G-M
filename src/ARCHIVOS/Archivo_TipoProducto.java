...
public class Archivo_TipoProducto {
      public void GuardarDatos(String Id, String nombre) throws IOException {

        try {
            FileWriter F1 = new FileWriter("TipoProducto.txt", true);
    ...
    public void Modificar(String LineaAntigua, String nuevalinea) {
        ...
        File Fnuevo = new File("archivo5.txt");
        File FAntiguo = new File("TipoProducto.txt");
