...
public class TxtComentario {

     public void GuardarDatos(String Id, String correo, String asunto, String comentario, String fecha) throws IOException {

        try {
            FileWriter F1 = new FileWriter("Comentarios.txt", true);

            PrintWriter pw = new PrintWriter(F1);
            pw.println(Id + " ; " + correo + " ; " + asunto + " ; " + comentario + " ; " + fecha);
            pw.close();
    ...
    public void Modificar(String LineaAntigua, String nuevalinea){
        ...
        File FAntiguo = new File("Comentarios.txt");
