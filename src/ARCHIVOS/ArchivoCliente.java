...
public class ArchivoCliente {
    ...
    public void GuardarDatos(String Id, String nombre, String ApellP, String ApellM, String telefono, String correo) throws IOException {

        try {
            FileWriter F1 = new FileWriter("Clientes.txt", true);

            PrintWriter pw = new PrintWriter(F1);
            pw.println(Id + "; " + nombre + "; " + ApellP + "; " + ApellM + "; " + telefono + "; " + correo);
            pw.close();
