...
public class DetallePedido {
      public void GuardarDatos(String Id, String Sec, String ID_P, String Cant, String Precio) throws IOException {

        try {
            FileWriter F1 = new FileWriter("Detalle_Pedidio.txt", true);

            PrintWriter pw = new PrintWriter(F1);
            pw.println(Id + "; " + Sec + "; " + ID_P + "; " + Cant + "; " + Precio );
            pw.close();
    ...
    public void Modificar(String LineaAntigua, String nuevalinea){
        ...
        File FAntiguo = new File("Detalle_Pedidio.txt");
